...
\matrix[tight matrix,
    ...
    column 1/.style={nodes={text width=4.5cm,font=\fontsize{9}{10}\selectfont\tt}},
    column 2/.style={nodes={text width=4.5cm,font=\fontsize{9}{10}\selectfont\tt}},
    column 3/.style={nodes={text width=1cm,font=\fontsize{9}{10}\tt}},
...
\matrix[tight matrix,
    ...
    row 1/.style={nodes={font=\small}},
    anchor=north west
] (route table v4) at ([yshift=-.2cm]route table v6.south west) {
IP addresses \& gateway \& iface \\
192.0.2.0/25 \& --- \& int1 \\
