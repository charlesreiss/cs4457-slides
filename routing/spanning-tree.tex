...
\draw[connect maybe,actual at=7,consider at=5] (G) -- (F)
...
\begin{visibleenv}<2>
    \node[draw,very thick] at (G.north east) {
        r=G,d=0,no link
    };
    \node[draw,very thick,alt=<2>{msg data}] at (E.south) {
        r=E,d=0,no link
    };
    \node[draw,very thick] at (F.south east) {
        r=F,d=0,no link
    };
    \node[draw,very thick] at (D.south west) {
        r=D,d=0,no link
    };
    \draw[msg link] (E) -- (G);
    \draw[msg link] (E) -- (F);
...
\end{visibleenv}
\begin{visibleenv}<3>
    \node[draw,very thick,draw=red] at (G.north east) {
        r=E,d=1,G--E
    };
    \node[draw,very thick] at (E.south) {
        r=E,d=0,no link
    };
    \node[draw,very thick,draw=red] at (F.south east) {
        r=E,d=0,F--E
    };
    \node[align=left,draw,very thick,draw=red] at (D.south west) {
        r=D,d=0,no link \\
        (D < G, so no update)
    };
    \draw[msg link] (E) -- (G);
...
\begin{visibleenv}<4>
    ...
    \node[draw,very thick,alt=<4>{msg data}] at (D.south west) {
        r=D,d=0,no link
    };
    \node[draw,very thick] at (B.north) {
        r=B,d=0,no link
    };
    \draw[msg link] (D) -- (B);
    \draw[msg link] (D) -- (E);
...
\begin{visibleenv}<5>
    ...
    \node[draw,very thick,draw=red] at (E.south) {
        r=D,d=1,E--D
    };
    \node[draw,very thick] at (F.south east) {
        r=E,d=0,F--E
    ...
    \node[align=left,draw,very thick,draw=red] at (B.north) {
        r=B,d=0,no link \\
        (B < D, no update)
    };
    \draw[msg link] (D) -- (B);
