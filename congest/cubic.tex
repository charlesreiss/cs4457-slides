...
\begin{frame}
    ...
    \item intuition for non-steady state:
        ...
        \item kinda looks like `slow start'-type probing
            \begin{itemize}
            \item but smooth interpolate rate from fast to very slow
            \end{itemize}
        \item worry about getting more precise size on next pass
        \end{itemize}
    \end{itemize}
\end{frame}
