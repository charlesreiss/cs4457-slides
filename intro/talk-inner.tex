...
\input{../intro/muxdemux}

\subsubsection{exercise}
\input{../intro/muxdemux-ex}

\subsection{store and forward}
\input{../intro/store-forward}
...
\input{../intro/client-server}

\subsection{exercise: terms}
\input{../intro/terms-exercise}
