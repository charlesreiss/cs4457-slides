...
[]{.my-small} (based on Google's BBR presentation to the IETF) <br> ![](/congest/texfig/watch-latency-some-intuition-based-on-bbr.figure.svg)
 
 ![](/congest/texfig/watch-latency-some-intuition-based-on-bbr_2.figure.svg)
...
* not great fairness results with traditional TCP 
   ...
   * Philip (IMC'21)\\footnote{Philip, Ware, Athapathu, Sherry, Sekar, ‘‘Revisting TCP Congestion Control Throughput Models &amp; Fairness Properties AT Scale'’ (IMC’21)} claims one BBR flow takes 40% of throughput when competing with thousands of CUBIC or NewReno flows
