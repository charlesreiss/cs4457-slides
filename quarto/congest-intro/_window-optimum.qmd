...
* let's say we lose packet $x$ [only], sender might 
 ...
 ![](/congest-intro/texfig/window-optimum.figure-1.svg){.absolute top="0%" left="0%" width=1050 height=600 .my-center  .fragment .fade-in-then-out fragment-index=1}
![](/congest-intro/texfig/window-optimum.figure-2.svg){.absolute top="0%" left="0%" width=1050 height=600 .my-center  .fragment .fade-in-then-out fragment-index=2}
