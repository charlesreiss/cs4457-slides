...
\draw[connect,one packet forward=1,one packet backward={2}{hilite=2},one packet backward=4] (c-15) -- (s1) node[port] {1};
...
\draw[connect,one packet backward=3,one packet backward=5] (c-90) -- (s2) node[port] {2};
\draw[connect,one packet backward=3,one packet backward=5] (c-135) -- (s2) node[port] {3};
\draw[connect,one packet backward=3,one packet backward=5] (c-180) -- (s2) node[port] {4};
    \draw[connect big,one packet forward=2,one packet backward={3}{hilite=3},one packet forward={4}{hilite=4},one packet backward={5}{hilite=5}] (s1) -- (s2) node[port beginning] {4} node [port] {1};
\node[anchor=north east] at ([yshift=3cm]c-180) {
