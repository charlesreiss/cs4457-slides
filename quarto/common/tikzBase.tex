...
\newlength{\mypaperwidth}\setlength{\mypaperwidth}{14.5cm}
\newlength{\mypaperheight}\setlength{\mypaperheight}{9cm}
\graphicspath{{}{./}{../}{../../}{../../common/}}
\input{common/listingsLib}
\pgfplotsset{compat=1.18}
\usetikzlibrary{arrows.meta,calc,patterns,positioning,matrix,shapes.multipart,fit,decorations.pathreplacing,shapes.callouts,shapes.misc,chains,spy}
\tikzset{ 
    ...
    tight matrix noline/.style={tight matrix no line},
    % FIXME: should use argument
    my callout/.style={draw,fill=blue!20!white,rectangle callout,alias=#1-callout},
...
\cs_generate_variant:Nn  \overlay_parse:n {e}
...
\NewCommandCopy\originalColor\color
\RenewDocumentCommand\color{D<>{1-}m}
  {
    \alt<#1>{\originalColor{#2}}{}
  }
\NewCommandCopy\originalSout\sout
\RenewDocumentCommand\sout{D<>{1-}m}
  {
    \alt<#1>{\originalSout{#2}}{#2}
  }
\NewDocumentCommand\myemph{D<>{1-}m}
  {
    \if_mode_math:
      \group_begin:\alt<#1>{\originalColor{orange!50!red}\mathit{#2}}{#2}\group_end:
    \else:
      \group_begin:\alt<#1>{\originalColor{orange!50!red}\itshape}{}#2\group_end:
    \fi
  }
\NewDocumentCommand\maybeEmph{D<>{1-}m}
  {
    \if_mode_math:
      \group_begin:\alt<#1>{\originalColor{orange!50!red}\mathit{#2}}{#2}\group_end:
    \else:
...
\RenewDocumentCommand\textbf{D<>{1-}m}
  {
...
\NewDocumentCommand{\insertoverlaynumber}{}{
    \int_use:N\g_overlay_current_slide_int%
}
