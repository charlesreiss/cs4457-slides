\begin{tikzpicture}
    ...
    \begin{scope}[x=4.7mm,y=7mm]
        ...
        \path[box,hi on=0] (0, 0) rectangle (16, -1) node[box label] {hardware address type};
        \path[box,hi on=2] (16, 0) rectangle (32, -1) node[box label] {`protocol' address type};
        \path[box,hi on=0] (0, -1) rectangle ++(8, -1) node[box label] {hardware address length};
       \path[box,hi on=2] (8, -1) rectangle ++(8, -1) node[box label] {`protocol' address len};
        ...
        \path[box,hi on=0] (0, -2) rectangle ++(32, -1.5) node[box label] {sender hardware addr};
        \path[box,hi on=0] (0, -3.5) rectangle ++(32, -1.5) node[box label] {sender protocol addr};
        \path[box,hi on=3] (0, -5) rectangle ++(32, -1.5) node[box label] {destination hardware addr};
        \path[box,hi on=0] (0, -6.5) rectangle ++(32, -1.5) node[box label] {destination protocol addr};
